...
import { MarketplaceABI } from "@/abi/MarketplaceABI" // Update the path
  ...
  const handleWalletConnect = async () => {
    ...
    if (typeof window.ethereum !== "undefined") {
      try {
        ...
        // Redirect or update the UI based on wallet connection
        setIsLoading(false)
      } catch (error) {
      ...
      setErrorMessage("MetaMask is not installed. Please install MetaMask to proceed.")
      setIsLoading(false)
    }
  }
    ...
    <div className="container flex h-screen items-center justify-center">
      <Card className="mx-auto max-w-md w-full">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">Sign up as an NGO</CardTitle>
          <CardDescription>Create an account to start selling carbon credits</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="email" className="w-full">
              ...
              <form onSubmit={handleEmailSignUp}>
                <div className="grid gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input id="ngo-name" placeholder="Green Earth Initiative" required />
                  </div>
                  <div className="grid gap-2">
            ...
            <TabsContent value="wallet">
              <div className="grid gap-4">
                ...
                {walletAddress && <p className="mt-4 text-center">Wallet connected: {walletAddress}</p>}
              </div>
            </TabsContent>
          </Tabs>
        </CardContent>
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/auth/ngo/signin" className="underline underline-offset-4 hover:text-primary">
              Sign in
            </Link>
          </div>
        </CardFooter>
